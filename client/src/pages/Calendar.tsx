    ...
    const [calendarInfo, setCalendarInfo] = useState({
        ...
        events: [
            [
                ...
                ['7pm @ 305 S Fanin', 'Clean day', 'called TBD'],
                ['7pm @ 305 S Fanin', 'Forever'],
                [''],
                ['7pm @ 305 S Fanin', 'work thru Act 1'],
                ['7pm @ 305 S Fanin', 'Finish working Act One', 'Run Act One'],
                [''],
                ['1pm @ 305 S Fanin'],
                ['MEMORIAL DAY', 'NO REHEARSAL'],
                ['7pm @ 305 S Fanin', 'p.76-83'],
                [''],
                ['7pm @ 305 S Fanin', 'p. 80-88'],
                ['7pm @ 305 S Fanin', 'p. 89-97'],
                [''],
            ],
            [
                ['1pm @ Rockwall HS', 'Freak Flag', 'Review Act One'],
                ['7pm @ Rockwall HS', 'p. 103-116'],
                ['7pm @ Rockwall HS', 'Choreo Scene 8', 'Review'],
                [''],
                ['7pm @ Rockwall HS', 'Music'],
                ['7pm @ Rockwall HS', 'Act 2'],
                [''],
                ['1pm @ Rockwall HS'],
                ['7pm @ Rockwall HS', 'Act 1'],
                ['7pm @ Rockwall HS', 'Act 2'],
                [''],
                ['7pm @ Rockwall HS'],
                ['7pm @ Rockwall HS'],
